...
export const BUILTIN_TEMPLATES: BuiltinTemplate[] = [
  ...
  // ── Growth / viral use-case templates ─────────────────────────────────────
  {
    ...
    category: "TOKEN",
    tagline: "Launch a token and distribute it virally",
    description:
      "Create an ERC20 token and a shareable airdrop claim page. Users connect wallet, complete optional tasks, and claim tokens — built-in per-wallet limit keeps it fair.",
    icon: "🚀",
    gradient: "from-violet-500 to-purple-600",
    accentColor: "#8b5cf6",
    params: [
      { key: "tokenName",      label: "Token Name",          type: "text",    required: true,  defaultValue: "AirdropToken",   placeholder: "e.g. ViralCoin" },
      { key: "symbol",         label: "Symbol",              type: "text",    required: true,  defaultValue: "AIR",            placeholder: "e.g. VIRL" },
      { key: "totalSupply",    label: "Total Supply",        type: "number",  required: true,  defaultValue: "1000000000",     placeholder: "1,000,000,000" },
      { key: "claimAmount",    label: "Claim Amount / Wallet", type: "number", required: true, defaultValue: "1000",           placeholder: "1,000" },
      { key: "description",    label: "Campaign Description", type: "text",   required: false, defaultValue: "Claim your free tokens. Limited supply. First come, first served.", placeholder: "Describe your airdrop" },
      { key: "accentColor",    label: "Brand Color",         type: "color",   required: false, defaultValue: "#8b5cf6" },
      { key: "theme",          label: "Theme",               type: "select",  required: false, defaultValue: "dark", options: ["dark", "light"] },
    ],
    defaultConfig: {
      ...
      totalSupply: "1000000000",
      claimAmount: "1000",
      description: "Claim your free tokens. Limited supply. First come, first served.",
      accentColor: "#8b5cf6",
      theme: "dark",
    },
    suggestedPrompts: [
      "Change token to ViralCoin with symbol VIRL and 500M supply",
      "Set claim limit to 500 tokens per wallet",
      "Add task: follow Twitter before claiming",
      "Change color to orange and add scarcity description",
    ],
  ...
  },
  {
    ...
    name: "Token Presale",
    category: "TOKEN",
    tagline: "Sell your token and raise funds",
    description:
      "Launch a token presale with ETH payment, hard cap, soft cap, and a countdown timer. Tokens are auto-distributed to buyers when the sale ends.",
    icon: "💰",
    gradient: "from-amber-500 to-yellow-500",
    accentColor: "#f59e0b",
    params: [
      { key: "tokenName",    label: "Token Name",          type: "text",    required: true,  defaultValue: "PresaleToken",  placeholder: "e.g. LaunchCoin" },
      { key: "symbol",       label: "Symbol",              type: "text",    required: true,  defaultValue: "PST",           placeholder: "e.g. LNC" },
      { key: "totalSupply",  label: "Total Supply",        type: "number",  required: true,  defaultValue: "1000000000",    placeholder: "1,000,000,000" },
      { key: "pricePerToken",label: "Price per Token (ETH)", type: "number", required: true, defaultValue: "0.0001",        placeholder: "0.0001" },
      { key: "hardCap",      label: "Hard Cap (ETH)",      type: "number",  required: true,  defaultValue: "100",           placeholder: "100" },
      { key: "softCap",      label: "Soft Cap (ETH)",      type: "number",  required: false, defaultValue: "10",            placeholder: "10" },
      { key: "description",  label: "Project Description", type: "text",    required: false, defaultValue: "Join the presale and be early. Tokens ship at launch.", placeholder: "Describe your project" },
      { key: "accentColor",  label: "Brand Color",         type: "color",   required: false, defaultValue: "#f59e0b" },
      { key: "theme",        label: "Theme",               type: "select",  required: false, defaultValue: "dark", options: ["dark", "light"] },
    ],
    defaultConfig: {
      ...
      hardCap: "100",
      softCap: "10",
      description: "Join the presale and be early. Tokens ship at launch.",
      accentColor: "#f59e0b",
      theme: "dark",
    },
    suggestedPrompts: [
      "Set hard cap to 500 ETH and price to 0.00005 ETH per token",
      "Add a soft cap of 50 ETH and 7-day countdown",
      "Change name to LaunchCoin with symbol LNC",
      "Add description about a DeFi protocol launching next month",
    ],
  ...
  },
  {
    ...
    name: "Token Faucet",
    category: "TOKEN",
    tagline: "Let users claim free tokens on a timer",
    description:
      "Deploy a free token faucet with time-based claims, anti-bot cooldown, and daily limit. Perfect for testnet tokens, community rewards, and developer testing.",
    icon: "💧",
    gradient: "from-cyan-500 to-sky-600",
    accentColor: "#06b6d4",
    params: [
      { key: "tokenName",    label: "Token Name",          type: "text",   required: true,  defaultValue: "FaucetToken",  placeholder: "e.g. TestCoin" },
      { key: "symbol",       label: "Symbol",              type: "text",   required: true,  defaultValue: "FCT",          placeholder: "e.g. TEST" },
      { key: "totalSupply",  label: "Total Supply",        type: "number", required: true,  defaultValue: "1000000000",   placeholder: "1,000,000,000" },
      { key: "claimAmount",  label: "Claim Amount",        type: "number", required: true,  defaultValue: "100",          placeholder: "100" },
      { key: "cooldownHours",label: "Cooldown (hours)",    type: "number", required: true,  defaultValue: "24",           placeholder: "24" },
      { key: "dailyLimit",   label: "Daily Limit (tokens)",type: "number", required: false, defaultValue: "10000",        placeholder: "10,000" },
      { key: "description",  label: "Description",         type: "text",   required: false, defaultValue: "Claim free tokens every 24 hours. No bots allowed.", placeholder: "Describe your faucet" },
      { key: "accentColor",  label: "Brand Color",         type: "color",  required: false, defaultValue: "#06b6d4" },
      { key: "theme",        label: "Theme",               type: "select", required: false, defaultValue: "dark", options: ["dark", "light"] },
    ],
    defaultConfig: {
      tokenName: "FaucetToken",
      symbol: "FCT",
      totalSupply: "1000000000",
      claimAmount: "100",
      cooldownHours: "24",
      dailyLimit: "10000",
      description: "Claim free tokens every 24 hours. No bots allowed.",
      accentColor: "#06b6d4",
      theme: "dark",
    },
    suggestedPrompts: [
      "Change to TestCoin and set claim to 50 tokens every 6 hours",
      "Set daily limit to 5000 tokens and add anti-bot description",
      "Change color to blue and name it DevFaucet",
      "Make it claim 1000 tokens with 12-hour cooldown",
    ],
  ...
  },
  {
    ...
    category: "OTHER",
    tagline: "Grow your users with token incentives",
    description:
      "Launch a referral program where users invite others and earn tokens per invite. Built-in unique referral links, on-chain earnings tracker, and claim dashboard.",
    icon: "🏆",
    gradient: "from-emerald-500 to-green-600",
    accentColor: "#10b981",
    params: [
      { key: "tokenName",      label: "Token Name",            type: "text",   required: true,  defaultValue: "ReferralToken", placeholder: "e.g. GrowthCoin" },
      { key: "symbol",         label: "Symbol",                type: "text",   required: true,  defaultValue: "REF",           placeholder: "e.g. GRW" },
      { key: "totalSupply",    label: "Total Supply",          type: "number", required: true,  defaultValue: "1000000000",    placeholder: "1,000,000,000" },
      { key: "rewardPerInvite",label: "Reward per Invite",     type: "number", required: true,  defaultValue: "100",           placeholder: "100 tokens" },
      { key: "maxReferrals",   label: "Max Referrals / Wallet",type: "number", required: false, defaultValue: "50",            placeholder: "50" },
      { key: "description",    label: "Description",           type: "text",   required: false, defaultValue: "Invite friends and earn tokens for every signup.", placeholder: "Describe your program" },
      { key: "accentColor",    label: "Brand Color",           type: "color",  required: false, defaultValue: "#10b981" },
      { key: "theme",          label: "Theme",                 type: "select", required: false, defaultValue: "dark", options: ["dark", "light"] },
    ],
    defaultConfig: {
      ...
      rewardPerInvite: "100",
      maxReferrals: "50",
      description: "Invite friends and earn tokens for every signup.",
      accentColor: "#10b981",
      theme: "dark",
    },
    suggestedPrompts: [
      "Change to GrowthCoin and give 250 tokens per referral",
      "Set max referrals to 100 and add a leaderboard",
      "Change color to gold for premium feel",
      "Add description about a trading platform launch campaign",
    ],
  ...
  },
  {
    ...
    name: "Reward Game",
    category: "OTHER",
    tagline: "Let users play and win tokens",
    description:
      "Launch a gamified reward system — spin wheel or scratch card. Users play and win random token amounts on cooldown. Highly engaging with on-chain provable fairness.",
    icon: "🎮",
    gradient: "from-rose-500 to-pink-600",
    accentColor: "#f43f5e",
    params: [
      { key: "tokenName",    label: "Token Name",           type: "text",   required: true,  defaultValue: "GameToken",  placeholder: "e.g. SpinCoin" },
      { key: "symbol",       label: "Symbol",               type: "text",   required: true,  defaultValue: "GAME",       placeholder: "e.g. SPIN" },
      { key: "totalSupply",  label: "Total Supply",         type: "number", required: true,  defaultValue: "1000000000", placeholder: "1,000,000,000" },
      { key: "minReward",    label: "Min Reward (tokens)",  type: "number", required: true,  defaultValue: "10",         placeholder: "10" },
      { key: "maxReward",    label: "Max Reward (tokens)",  type: "number", required: true,  defaultValue: "1000",       placeholder: "1,000" },
      { key: "cooldownHours",label: "Cooldown (hours)",     type: "number", required: true,  defaultValue: "1",          placeholder: "1" },
      { key: "gameStyle",    label: "Game Style",           type: "select", required: false, defaultValue: "spin", options: ["spin", "scratch"] },
      { key: "description",  label: "Game Description",     type: "text",   required: false, defaultValue: "Spin the wheel. Win tokens. Try again tomorrow.", placeholder: "Describe your game" },
      { key: "accentColor",  label: "Brand Color",          type: "color",  required: false, defaultValue: "#f43f5e" },
      { key: "theme",        label: "Theme",                type: "select", required: false, defaultValue: "dark", options: ["dark", "light"] },
    ],
    defaultConfig: {
      tokenName: "GameToken",
      ...
      cooldownHours: "1",
      gameStyle: "spin",
      description: "Spin the wheel. Win tokens. Try again tomorrow.",
      accentColor: "#f43f5e",
      theme: "dark",
    },
    suggestedPrompts: [
      "Change to SpinCoin and set max reward to 5000 tokens",
      "Make it a scratch card with 30-min cooldown",
      "Change color to neon purple for a casino feel",
      "Set min reward to 50 and max to 2000 tokens",
    ],
